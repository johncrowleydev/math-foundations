...
import { literalProps } from '../../tools/content/lesson-mdx-policy.js';

const parser = unified().use(remarkParse).use(remarkMath).use(remarkMdx);

/**
 * Compare native MDX figures with the semantic records captured from the deployed
 * notebook. This test helper never creates legacy Markdown or renders content.
 */
