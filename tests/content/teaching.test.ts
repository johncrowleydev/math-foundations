...
import { loadTeaching, teachingBlocks, linkTeachingTerms } from '../../tools/content/teaching.js';
...
import { validateFormulaContexts } from '../../tools/content/formula-context.js';
...
test('Cartesian statistical annotations are optional and authored ticks stay bounded', async () => {
  const { figureSchema } = await import('../../tools/content/teaching.js');
