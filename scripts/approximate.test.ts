...
const fixtures = JSON.parse(await readFile('shared/approximate-fixtures.json', 'utf8')) as {
  name: string;
...
for (const f of JSON.parse(await readFile('shared/approximate-definition-cases.json', 'utf8')))
