import { lesson, section, citation } from './helpers.mjs';
import { mmlModels } from './inference-sources.mjs';
const probability = citation(
  'introduction-probability',
  'pishro-nik',
  '§1.3.1 Random Experiments',
  'https://www.probabilitycourse.com/chapter1/1_3_1_random_experiments.php',
  'Experiments, observed outcomes, and probability models supporting the original subject orientation.',
);
const inference = citation(
  'introduction-inference',
  'pishro-nik',
  '§8.1.0 Introduction to Statistical Inference',
  'https://www.probabilitycourse.com/chapter8/8_1_0_intro.php',
  'The distinction between working from a specified probability model and drawing conclusions about unknown quantities from data.',
);
