...
This lesson builds on [Sequences and Summations](../lessons/06-sequences-and-summations.mdx), [Mathematical Induction](../lessons/10-mathematical-induction.mdx), and [Strong Induction](../lessons/11-strong-induction.mdx). Sequence values and coefficients are real unless another domain is stated. We will work with integer indices and use algebra and finite sums. No calculus is needed.
...
<Figure id="recurrence-dependencies" alt="A term depends on two predecessors" />
...
<Figure id="recurrence-levels" alt="Count calls and work at each level" />
