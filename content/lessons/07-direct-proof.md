...
This lesson builds on [Predicates and Quantifiers](../lessons/02-predicates-and-quantifiers.md), [Sets and Set Operations](../lessons/03-sets-and-set-operations.md), and [Functions](../lessons/05-functions.md). The algebra is elementary; the new skill is controlling what you have assumed and what remains to be shown.
