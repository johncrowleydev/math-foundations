...
This lesson builds on [Functions](../lessons/05-functions.mdx) and [Sets and Set Operations](../lessons/03-sets-and-set-operations.mdx). Our numeric terms and constants are real numbers unless a more restrictive domain is stated. We work with finite sums and products. Infinite sequences may supply terms, but we will not define or evaluate infinite series, which require additional ideas about limits.
...
<Figure id="sequence-arithmetic" alt="Equal additions, indexed terms" />

<Figure id="sequence-geometric" alt="Equal ratios, different increments" />
...
<Figure id="sum-triangles" alt="Two triangles make a rectangle" />
