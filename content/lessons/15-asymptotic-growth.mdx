...
This lesson builds on [Functions](../lessons/05-functions.mdx), [Sequences and Summations](../lessons/06-sequences-and-summations.mdx), and [Recurrence Relations](../lessons/13-recurrence-relations.mdx). We will use integer input sizes and elementary inequalities. No limit or calculus machinery is required.
...
<Figure id="growth-eventual-bound" alt="The bound begins at a threshold" />
...
<Figure id="growth-comparison" alt="Different shapes on a shared scale" />
...
<Figure id="growth-loop-region" alt="Each square is one inner-body execution" />
