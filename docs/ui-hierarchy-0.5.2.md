...
- Published 0.5.2 (version code 11) as the latest OTA release. The public latest manifest and APK download were verified: 52,565,157 bytes, SHA-256 `35179a927c72bae79bdc28a47a7493ae9181ed096f80420d4838242ae9863dd2`, and the existing installation signing certificate.
- The Samsung was unavailable for physical checks. The owner explicitly instructed publication without those checks and clarified that this personal project has no mandatory release gates. Device availability must not be treated as a release blocker imposed by the agent.
